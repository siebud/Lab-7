 ...
 * medical treatment. Patients are treated one at a time by Last in First out. Once a patient is treated,
...
public class StackHospital<PatientType> extends Hospital{
	...
	/**
	 * Overrides Hospital addPatient method to add a patient to the hospital at the beginning of the list
	 *
